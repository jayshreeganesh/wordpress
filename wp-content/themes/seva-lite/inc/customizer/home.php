    ...
    /** Wheel of life section */
        ...
        $wp_customize->add_control(
            new Seva_Lite_Radio_Buttonset_Control(
                ...
                array(
                    'section'	  => 'wheel_of_life',
                    'choices'	  => array(
                        'coach' => __( 'Coach Podium', 'seva-lite' ),
                        'wol'   => __( 'Wheel of Life Plugin', 'seva-lite' ),
                    ),
                    'active_callback' => 'seva_lite_wheeloflife_ac',
                )
            )
        ...
        $wp_customize->add_control(
            new Seva_Lite_Note_Control( 
                ...
                array(
                    'section'         => 'wheel_of_life',
                    'description'     => sprintf( __( '%1$sCoach Podium%2$s helps coaches to create interactive "Wheel of Life" assessments to generate leads and enhance client engagement. Learn how to %3$screate Wheel of Life assessment using Coach Podium.%4$s ', 'seva-lite' ), '<a href="https://coachpodium.com/?utm_source=theme_customizer&utm_medium=theme&utm_campaign=blossom" target="_blank">', '</a>','<a href="https://docs.coachpodium.com/article/creating-wheel-of-life-assessment/?utm_source=theme_customizer&utm_medium=theme&utm_campaign=blossom" target="_blank" >', '</a>' ),
                    'active_callback' => 'seva_lite_wheeloflife_ac'
                )
            )
        );
        ...
        $wp_customize->add_setting(
            'wheeloflife_cp_text',
            array(
                'default'           => __( 'Start Assessment','seva-lite' ),
                'sanitize_callback' => 'sanitize_text_field'
            )
        );
    ...
    if( seva_lite_is_wheel_of_life_activated() ){
        ...
        $wp_customize->add_control(
            new Seva_Lite_Note_Control( 
                ...
                array(
                    'section'         => 'wheel_of_life',
                    'description'     => sprintf( __( '%1$sWheel of Life plugin%2$s helps to create interactive assessment for lead generation. Refer to this %3$sdocumentation%4$s to configure the plugin.', 'seva-lite' ),'<a href="https://wheeloflife.pro/?utm_source=customizer&utm_medium=BT" target="_blank">','</a>', '<a href="https://wheeloflife.pro/docs/" target="_blank">', '</a>' ),
                    'active_callback' => 'seva_lite_wheeloflife_ac'
                )
            )
        );
        ...
        $wp_customize->add_control(
            new Seva_Lite_Note_Control( 
                ...
                array(
                    'section'     => 'wheel_of_life',
                    'description' => sprintf( __( 'Refer to this %1$sdocumentation%2$s to learn how to use the shortcode.', 'seva-lite' ), '<a href="https://wheeloflife.pro/docs/how-to-display-embed-wheel-of-life-assessments/" target="_blank">', '</a>' ),
                    'active_callback' => 'seva_lite_wheeloflife_ac'
                )
            )
        );
