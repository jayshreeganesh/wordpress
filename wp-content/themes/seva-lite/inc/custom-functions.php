...
function seva_lite_admin_notice(){
    ...
    $dismissnonce    = wp_create_nonce( 'seva_lite_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=seva-lite-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'seva-lite' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?seva_lite_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'seva-lite' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function seva_lite_update_admin_notice(){
    if (!current_user_can('manage_options')) {
     ...
     if ( ( isset( $_GET['seva_lite_admin_notice'] ) && $_GET['seva_lite_admin_notice'] = '1' ) && wp_verify_nonce( $_GET['_wpnonce'], 'seva_lite_admin_notice' ) ) {
