...
$read_more             = get_theme_mod( 'slider_readmore', __( 'Read More', 'thrive-coach' ) );
$banner_title          = get_theme_mod( 'banner_title', __( 'Let\'s Build your Dream life together', 'thrive-coach' ) );
$banner_subtitle       = get_theme_mod( 'banner_subtitle', __( 'Welcome', 'thrive-coach' ) );
$banner_content        = get_theme_mod( 'banner_content', __( 'To empower women to make a positive impact on the world with fiery passion, unbridled self-belief, and head-turning style.', 'thrive-coach' ) );
$banner_label          = get_theme_mod( 'banner_label', __( 'GET STARTED', 'thrive-coach' ) );
$cta_banner_image      = get_theme_mod( 'cta_banner_secondary_image' );
$banner_img_id         = attachment_url_to_postid( $cta_banner_image );
$banner_link           = get_theme_mod( 'banner_link', '#' );
$banner_caption_layout = get_theme_mod( 'banner_caption_layout', 'left' );
$cta_layout            = get_theme_mod( 'banner_layout', 'one' );
    ...
    <div id="banner_section" class="site-banner static-cta style-<?php echo esc_attr( $cta_layout ); ?><?php if( has_header_video() ) echo esc_attr( ' video-banner' ); ?>">
        <div class="container">
            ...
            <?php 
                ...
                if( $cta_banner_image && $cta_layout == 'one' ) {
                    echo '<div class="banner-secondary-img">';
